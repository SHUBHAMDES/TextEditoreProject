...
// initialize menu item
   ...
   //add action lesnar to five menu item
   ...
   //Add menu item to file menu
        ...
        //Add action lisener to edit manu itam
...
//set  page dinenstions frame size
    ...
    @Override
    //action event->ehich action is occure when event is occure
  ...
  if(actionEvent.getSource()==cut){
      ...
      textArea.cut();
        ...
        if(actionEvent.getSource()==openFile){
            //open a text file
            //intilise file chooser
          JFileChooser fileChooser=new JFileChooser("C:");
            //get choose option from file chooser
          int chooseOption=fileChooser.showOpenDialog(null);
           //if choose opetion is equal to approve
